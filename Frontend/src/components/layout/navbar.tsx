    ...
    >
      <div className="flex items-center gap-4">
        ...
        <motion.div
          ...
          className={cn(
            ...
            isSearchFocused
              ? "bg-[--color-bg-surface] border-[--color-accent] ring-1 ring-[--color-accent]"
              : "bg-[--color-border-subtle]/50 border-[--color-border-glass]"
          )}
        >
          <motion.div
          ...
          >
            <Search
              ...
              className={cn(
                "transition-colors",
                isSearchFocused ? "text-[--color-accent]" : "text-[--color-text-secondary]"
              )}
            />
          </motion.div>
          <input
            type="text"
            placeholder="Search..."
            className="bg-transparent border-none outline-none text-sm text-[--color-text-primary] placeholder:text-[--color-text-disabled] w-32 focus:outline-none transition-all"
      ...
      <div className="flex items-center gap-2">
        ...
        >
          ...
          >
            <motion.span
              className="absolute inset-0 h-full w-full rounded-full bg-[--color-accent]"
        ...
        <DropdownMenu>
          <DropdownMenuTrigger className="focus:outline-none">
            <motion.div
              ...
              className="flex items-center gap-2 rounded-full p-1 pr-3 hover:bg-[--color-border-subtle] transition-colors cursor-pointer"
            >
              <motion.div
              ...
              <ChevronDown
                size={14}
                className="hidden md:block text-[--color-text-secondary]"
              />
            </motion.div>
          </DropdownMenuTrigger>
